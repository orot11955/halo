...
/**
 * Inline, stroke-based SVG icon set.
 * Replaces the previous text-glyph icons (◇▣◧◐✦) which rendered
 * inconsistently across fonts and were hard to read at small sizes.
 */
...
const ICON_PATHS: Record<IconName, JSX.Element> = {
  ...
  network: (
    <>
      ...
      <path d="M8 7l8 0M8 17l8 0M7 8l0 8M17 8l0 8" />
    </>
  ),
  globe: (
    <>
  ...
  language: (
    <>
      <circle cx="12" cy="12" r="9" />
      <path d="M3 12h18" />
      <path d="M12 3a13 13 0 0 1 4 9 13 13 0 0 1-4 9" />
      <path d="M12 3a13 13 0 0 0-4 9 13 13 0 0 0 4 9" />
    </>
  ),
  user: (
    <>
  ...
  inbox: (
    <>
      ...
      <path d="M3 12h5l1.5 2.5h5L16 12h5v5a2 2 0 0 1-2 2H5a2 2 0 0 1-2-2v-5Z" />
    </>
  ),
